        ...
        <div class="col-lg-6">
          <form class="" action="login_handler.php" method="post">
            <div class="form-group row">
              <label for="username" class="col-lg-4 py-2">Enter Username :</label>
              <input type="text" class="form-control col-lg-7" name="username" placeholder="Username">
            </div>
            <div class="form-group row">
              <label for="password" class="col-lg-4 py-2">Enter Password :</label>

...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="main_container container">
      <form class="form" action="" method="post">
        ...
        <div class="form-group row">
          ...
          <input type="file" class="col-lg-6 py-2" name="profile_img" value="">
        </div>
        <div class="form-group row">
    ...
    if($conn == True && isset($_POST['save_data'])){
      ...
      $sql = "insert into user_data values(null, '$name','$email','$password','$mobile','$gender','$reading','$singing','$playing')";
